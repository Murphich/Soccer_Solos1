...
local CiderRunMode = {};CiderRunMode.runmode = 'RUN';CiderRunMode.assertImage = true;CiderRunMode.userdir = "/Users/Murphich/Library/Application Support/luaglider2/dev";local SOCKET_PORT=58088;local GLIDER_MAIN_FOLDER= "/Users/Murphich/Desktop/Lua CA/CA";local useNativePrint= false;local snapshotInterval= -1;local snapshotInterval= -1;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()
